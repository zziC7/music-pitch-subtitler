...
OUTPUT_VIDEO_NAME = f"output_mp4/{file_stem}_音高版.mp4"
OUTPUT_SRT_NAME = f"output_srt/{file_stem}_音高.srt"
FONT_SIZE = 80                       # 字幕字号
...
def main(input_path):
    ...
    try:
        ...
        if midi_obj:
            ...
            print(f"--- 步骤 4.5: 保存 SRT 字幕文件 ---")
            generate_srt(midi_obj, OUTPUT_SRT_NAME)
